...
export class FbFeedService {
   ...
   "data":[  
      {  
         "message":"Come step into the world of entrepreneurship with E-Cell, IITK.\nWith 'Transcending Ideas' as the main motif, esummit'18 aims to go beyond mere ideas into actuality.\n#eSummit2k18 ‪#ECell_IITK",
      ...
      {  
         "message":"Thought nothing could top an edition of UPSTART at IIT Kanpur? \nWe unveil to you UPSTART Delhi!!\n\nLiving up to its thriving legacy, UPSTART, a pitching event like none other with mentoring by revered VCs and Investors and funding opportunities up to Rs. 1 crore, is here again to provide the boost your startup needs.\nPrizes worth 7.5 Lakhs at stake!!\nRegister now at https://www.ecelliitk.org/upstart18/delhi.html\n#StartUpIndia #eSummit2k18 ‪#ECell_IITK #UpStart18",
      ...
      {  
         "message":"\"Though there is 1% chance we'll have 99% hope.\" - Neymar Jr. after F.C. Barcelona's 0-4 loss in the first leg of Champions League quarter finals. Contrary to critics verdict Barca beat PSG 6-1 in second leg to advance to the semi finals.\nSetbacks are inevitable in the idea to reality progression of a startup. What counts is that you tenaciously face every trial!\n#FootballLessons #E_Lesson #FifaWC\n#eSummit2k18",
      ...
      {  
         "message":"Its the first time in last 80 years that Germany, the defending champions, failed to qualify for the knockout stage.\n'No matter how great you are, you are only one mistake away from losing everything.'\nEntrepreneurs need to keep on adapting and outdoing past performances to stay relevant.\n#eSummit2k18 #FootballLessons #E_Lesson #FifaWC",
      ...
      {  
         "message":"With PayPal, SpaceX, Tesla Motors, Hyperloop One, The boring company and now even contemplating ET colonization. We wish @elonmusk another year of making the impossible happen.\n\n#elonmusk #tesla #spacex #hyperloop #hyperloopone #theboringcompany #neuralink #openai #ai",
